...
public class GradeProg2 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("Enter grades, type -99 to finish");
		
		double aGrade=in.nextDouble();
		int ctr = 0;
		while( aGrade !=-99 && ctr<grades.length)
		{
			grades[ctr] = aGrade;
			ctr+=1;
			
			aGrade = in.nextDouble();
		}
		//now we found the size of array
		int size = ctr;
